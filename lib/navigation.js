(function () {
    ...
    function clearSearchFromReplacementButton(event) {
        ...
        // docsify-themeable replaces Docsify v5's original button after its
        // listener is bound. Delegation keeps clearing reliable even when a
        // theme or future plugin swaps the button node again.
        input.value = '';
        var resultsPanel = search.querySelector('.results-panel');
        var resultsStatus = search.querySelector('.results-status');
    ...
    function syncSidebarToggleState() {
        ...
        // mobile drawer is open. This site-owned sibling is the dismissible
        // backdrop, so it must remain pointer-active; CSS keeps it inert to
        // interaction whenever the drawer itself is closed.
