(function () {
    ...
    function loadExternalCategoryCardIcon(card, link) {
        ...
        favicon.onload = function () {
            if (!favicon.naturalWidth || !favicon.naturalHeight) return;
            iconContainer.classList.add('has-site-icon');
            iconContainer.replaceChildren(favicon);
        };
        favicon.onerror = function () {
            favicon.onload = null;
            favicon.onerror = null;
        };
        favicon.src = new URL('/favicon.ico', target.origin).href;
    }
