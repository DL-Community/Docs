(function () {
    ...
    var mobileSidebarLockedLocation = '';
    ...
    function syncMobileSidebarScrollLock(locked) {
        ...
        if (locked) {
            ...
            mobileSidebarLockedLocation = window.location.href;
        ...
        var restoreLocation = mobileSidebarLockedLocation;
        body.classList.remove(lockClass);
        root.classList.remove(lockClass);
        body.style.removeProperty('--docs-mobile-sidebar-scroll-y');
        mobileSidebarLockedScrollY = null;
        mobileSidebarLockedLocation = '';

        if (restoreLocation === window.location.href && typeof restoreScrollY === 'number') {
