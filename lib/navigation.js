(function () {
    ...
    function languageDefinitions() {
        ...
        return Array.prototype.map.call(links, function (link) {
            return {
                ...
                label: link.dataset.languageLabel || link.textContent || link.dataset.languageCode,
    ...
    function syncHeader() {
        ...
        if (currentLanguageLabel) currentLanguageLabel.textContent = currentLanguage.label;
        ...
        languageDefinitions().forEach(function (definition) {
            ...
            definition.link.textContent = definition.label;
